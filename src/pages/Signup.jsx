...
const GENRES = [
  ...
  "Historical Fiction","Psychology","Self-Help","Biography",
  "Horror","Classics","Young Adult",
];
...
export default function Signup({ navigate, onSignup }) {
  ...
  const [formData, setFormData] = useState({
    ...
    favoriteAuthor: "", readingGoal: "", preferredGenres: [],
  });
    ...
    try {
      ...
      if (userSnap.exists()) {
        ...
        userData = {
          ...
          joined: "2026", favoriteAuthor: "",
          readingGoal: 12, preferredGenres: [], bio: "",
        };
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setError("");
    const { name, email, password, confirmPassword, favoriteAuthor, readingGoal, preferredGenres } = formData;
    ...
    try {
      ...
      const newUser = {
        ...
        joined: "2026", favoriteAuthor,
        readingGoal: Number(readingGoal) || 12, preferredGenres, bio: "",
      };
  ...
  return (
    <div className="auth-page">
      <div className="auth-card auth-card-wide">
        ...
        <p className="auth-subtitle">Join BookBridge and personalize your reading journey.</p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <input type="text" name="favoriteAuthor" placeholder="Favorite author (optional)" value={formData.favoriteAuthor} onChange={handleChange} />

          {/* FIX: Clearer reading goal label */}
          <input
            type="number"
            name="readingGoal"
            ...
            <div className="genre-options">
              {GENRES.map((genre) => (
                <button type="button" key={genre}
                  className={`genre-pill ${formData.preferredGenres.includes(genre) ? "selected" : ""}`}
